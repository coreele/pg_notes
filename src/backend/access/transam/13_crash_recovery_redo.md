...
**相关笔记**: [WAL Recovery（故障域）](./09_wal_recovery.md) · [Full Page Writes](./10_full_page_writes.md) · [XLogRecPtr (LSN)](./11_xlogrecptr_lsn.md) · [Mini-Transaction](./12_mini_transaction.md)
