...
观测 Visibility Map 置位 / 清位，以及 Index Only Scan 是否因此免访堆。机制见 [Why & How: VM](../backend/access/heap/02_vm.md)；计划形态见 [Index Only Scan](../backend/access/nbtree/01_plan.md)。
...
**相关笔记**: [Visibility Map](../backend/access/heap/02_vm.md) · [Heap AM](../backend/access/heap/heap.md) · [Index Only Scan](../backend/access/nbtree/01_plan.md) · [pageinspect](../tools/01_pageinspect.md)
