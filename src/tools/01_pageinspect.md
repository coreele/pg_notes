...
观测堆/索引页二进制布局的 contrib 工具。页结构示意见 [Page Layout](../backend/storage/page/01_page_layout.md)。
...
![disk page organization](../backend/storage/assets/page_table_file.png)
...
![](../backend/storage/assets/page_header_tuple.png)
